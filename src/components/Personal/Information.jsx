...
const Information = () => {
  return (
    <div className="divide-y max-[768px]:w-full max-[768px]:flex max-[768px]:flex-col max-[768px]:items-center sm:flex sm:flex-col sm:items-center xl:block">
      ...
      <p className="text-xl max-[768px]:w-fit w-5/6 text-justify font-medium mt-5">Welcome to my home. I'm Quan, a web developer with a create vision and a knack for problem-solving. With a solid foudation in HTML, CSS and Javascript, some technology like ReactJs, NodeJs,...
      ...
      <p className="text-xl  max-[768px]:text-center max-[768px]:mb-6 sm:flex sm:justify-center xl:block font-medium mt-5 w-5/6">
